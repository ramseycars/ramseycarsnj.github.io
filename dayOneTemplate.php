...
<div class="dayOne">
  ...
  <textarea id="dayOne" cols="1" rows="1" style="font-size:15px; font-family:Arial;color:#fff;border-color:#fff;text-decoration:none;resize: none;">
  ...
  <span style="font-size:18px;">Day One Template</span> &nbsp;&nbsp;&nbsp;	<button onclick="copy()">Copy</button><br>
  </center>
  <script type="text/javascript">
  	function copy(){
  		var text = document.getElementById('dayOne');
